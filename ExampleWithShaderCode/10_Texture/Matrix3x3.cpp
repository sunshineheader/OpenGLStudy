...
Matrix3x3::Matrix3x3(float scalex, float scaley, float scalez)
{
	matrix[0][0] = scalex; matrix[0][1] = 0.0f;   matrix[0][2] = 0.0f;
	matrix[1][0] = 0.0f;   matrix[1][1] = scaley; matrix[1][2] = 0.0f;
	matrix[2][0] = 0.0f;   matrix[2][1] = 0.0f;   matrix[2][2] = scalez;
}
Matrix3x3::Matrix3x3(
...
const bool Matrix3x3:: operator== (const Matrix3x3 & right) const
{
