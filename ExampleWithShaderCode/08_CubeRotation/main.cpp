...
void MyReenderOpenGL()
{
	...
	// 读取Uniform 属性
	// modelPoisition -> worldPosition -> viewPosition
	// model -> view -> projection
	mat4 translationMatrix = glm::translate(mat4(), vec3(0.0f, 0.0f, -2.0f));
	mat4 rotationMatrix = glm::rotate(mat4(), 4.0f,glm::vec3(1.0f,0.0f,0.0f));
	//mat4 modelTransformMatrix = glm::translate(mat4(), vec3( 0.0f, 0.0f, -1.5f ));
	mat4 projectionMatrix = glm::perspective(60.0f, 
		(GLfloat)(window_width / window_height), 0.1f, 10.0f);
